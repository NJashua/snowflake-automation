...
#         source_database = st.text_input('source_database')
#         destination_database = st.text_input('destination_database')

#         if st.button('Copy Schema'):
#             with st.spinner("please wait"):
#                 time.sleep(3)
#                 success = snowflake_tasks.copy_schema(source_schema, destination_schema, source_database, destination_database)
#                 if success:
...
#         destination_schema = st.text_input('Destination Schema Database', key='destination_schema')
...
#                 success = snowflake_tasks.copy_schema_database(source_schema, destination_schema, source_database, destination_database)
#                 if success:
#                     st.success("Schema copied to database successfully.")
#                 else:
#                     st.error("An error occurred while copying the schema.")
